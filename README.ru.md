...
*Дашборд бизнес-аналитики с ключевыми метриками воронки: общее число лидов, горячие лиды, handoff rate и процент ошибок. Данные агрегируются ежедневно ИИ-аналитиком.*
...
*   **Слой санитизации входящих данных:** выделенная нода PII_Guard перехватывает все входящие payload'ы и маскирует персональные данные (номера телефонов, форматы банковских карт) до того, как они попадают в LLM или логи.
